...
{
public:
    static Sync * fence(gl::GLenum condition = gl::GL_SYNC_GPU_COMMANDS_COMPLETE, gl::UnusedMask flags = static_cast<gl::UnusedMask>(0));

    virtual ~Sync();

    gl::GLenum clientWait(gl::SyncObjectMask flags = gl::GL_SYNC_FLUSH_COMMANDS_BIT, gl::GLuint64 timeout = gl::GL_TIMEOUT_IGNORED);
    void wait(gl::UnusedMask flags = static_cast<gl::UnusedMask>(0), gl::GLuint64 timeout = gl::GL_TIMEOUT_IGNORED);
