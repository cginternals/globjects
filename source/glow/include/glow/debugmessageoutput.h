...
/** Sets up a context specific debug message error callback that outputs
    ...
    This should be faster than using gl::GetError / CheckGLError and allows
    ...
    4.3 core profile. The output can be locally disabled via gl::Enable and
    gl::Disable(gl::DEBUG_OUTPUT) - this sets DEBUG_OUTPUT_SYNCHRONOUS_ARB.
 */
