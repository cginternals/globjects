...
int MacContext::id() const
{
//    return reinterpret_cast<int>(m_hRC);
    return 0;
}

bool MacContext::isValid() const
{
    return 0 < id();
}

bool MacContext::setSwapInterval(Context::SwapInterval swapInterval) const
{
...
bool MacContext::makeCurrent() const
{
...
bool MacContext::doneCurrent() const
{
