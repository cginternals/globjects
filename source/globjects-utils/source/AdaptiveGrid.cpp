...
,   m_size(0)
{
    ...
    StringTemplate* vertexShaderString = new StringTemplate(new glo::StaticStringSource(s_vsSource));
    StringTemplate* fragmentShaderString = new StringTemplate(new glo::StaticStringSource(s_fsSource));
