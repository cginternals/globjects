...
,   m_samplerIndex(0)
{
    ...
    gloutils::StringTemplate* vertexShaderSource = new gloutils::StringTemplate(new StaticStringSource(s_defaultVertexShaderSource));
    gloutils::StringTemplate* fragmentShaderSource = new gloutils::StringTemplate(new StaticStringSource(s_defaultFagmentShaderSource));
