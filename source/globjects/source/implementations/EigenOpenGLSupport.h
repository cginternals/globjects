...
// Copyright (C) 2018 David Vanderhaeghe <vdh@irit.fr> for glbinding adaptation
//
// This Source Code Form is subject to the terms of the Mozilla
// Public License v. 2.0. If a copy of the MPL was not distributed
// with this file, You can obtain one at http://mozilla.org/MPL/2.0/.

#ifndef EIGEN_OPENGL_MODULE2
#define EIGEN_OPENGL_MODULE2
...
#define EIGEN_GL_FUNC2_DECLARATION(FUNC,ARG0,ARG1,CONST)                \
namespace internal {                                                                                                            \
  template< typename XprType,                                                                                                   \
            typename Scalar = typename XprType::Scalar,                                                                         \
            int Rows = XprType::RowsAtCompileTime,                                                                              \
  ...
  template<typename XprType, typename Scalar, int Rows, int Cols>                                                               \
  struct EIGEN_CAT(EIGEN_CAT(gl_,FUNC),_impl)<XprType,Scalar,Rows,Cols,false> {                                                 \
      inline static void run(ARG0 pr, ARG1 a,EIGEN_GL_EVAL(EIGEN_GL_MAKE_CONST_##CONST) XprType& p) { \
          EIGEN_CAT(EIGEN_CAT(gl_,FUNC),_impl)<typename plain_matrix_type_column_major<XprType>::type>::run(pr,a,p); } \
  };                                                                                                                            \
}                                                                                                                               \
                                                                                                                                \
template<typename Derived> inline void FUNC(ARG0 pr,ARG1 a,EIGEN_GL_EVAL(EIGEN_GL_MAKE_CONST_##CONST) Eigen::DenseBase<Derived>& p) { \
  EIGEN_CAT(EIGEN_CAT(internal::gl_,FUNC),_impl)<Derived>::run(pr,a,p.derived());                                                  \
}


#define EIGEN_GL_FUNC2_SPECIALIZATION_MAT(FUNC,ARG0, ARG1,CONST,SCALAR,ROWS,COLS,SUFFIX) \
namespace internal {                                                                                                            \
  template< typename XprType> struct EIGEN_CAT(EIGEN_CAT(gl_,FUNC),_impl)<XprType, SCALAR, ROWS, COLS, true> {                  \
      inline static void run(ARG0 pr,ARG1 a, EIGEN_GL_EVAL(EIGEN_GL_MAKE_CONST_##CONST) XprType& p) { FUNC##SUFFIX(pr,a,p.data()); } \
  }; \
}


#define EIGEN_GL_FUNC2_SPECIALIZATION_VEC(FUNC,ARG0,ARG1,CONST,SCALAR,SIZE,SUFFIX) \
namespace internal {                                                                                                            \
  template< typename XprType> struct EIGEN_CAT(EIGEN_CAT(gl_,FUNC),_impl)<XprType, SCALAR, SIZE, 1, true> {                     \
      inline static void run(ARG0 pr,ARG1 a, EIGEN_GL_EVAL(EIGEN_GL_MAKE_CONST_##CONST) XprType& p) { FUNC##SUFFIX(pr,a,p.data()); } \
  };                                                                                                                            \
...
inline void glProgramUniform2fv_ei  (GLuint prog, GLint loc, const float* v)         { glProgramUniform2fv(prog,loc,1,v); }
inline void glProgramUniform2iv_ei  (GLuint prog, GLint loc, const int* v)           { glProgramUniform2iv(prog,loc,1,v); }

inline void glProgramUniform3fv_ei  (GLuint prog, GLint loc, const float* v)         { glProgramUniform3fv(prog,loc,1,v); }
inline void glProgramUniform3iv_ei  (GLuint prog, GLint loc, const int* v)           { glProgramUniform3iv(prog,loc,1,v); }

inline void glProgramUniform4fv_ei  (GLuint prog, GLint loc, const float* v)         { glProgramUniform4fv(prog,loc,1,v); }
inline void glProgramUniform4iv_ei  (GLuint prog, GLint loc, const int* v)           { glProgramUniform4iv(prog,loc,1,v); }

inline void glProgramUniformMatrix2fv_ei  (GLuint prog, GLint loc, const float* v)         { glProgramUniformMatrix2fv(prog,loc,1,false,v); }
inline void glProgramUniformMatrix3fv_ei  (GLuint prog, GLint loc, const float* v)         { glProgramUniformMatrix3fv(prog,loc,1,false,v); }
inline void glProgramUniformMatrix4fv_ei  (GLuint prog, GLint loc, const float* v)         { glProgramUniformMatrix4fv(prog,loc,1,false,v); }


EIGEN_GL_FUNC2_DECLARATION       (glProgramUniform,GLuint,GLint,const)
EIGEN_GL_FUNC2_SPECIALIZATION_VEC(glProgramUniform,GLuint,GLint,const,float,        2,2fv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_VEC(glProgramUniform,GLuint,GLint,const,int,          2,2iv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_VEC(glProgramUniform,GLuint,GLint,const,float,        3,3fv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_VEC(glProgramUniform,GLuint,GLint,const,int,          3,3iv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_VEC(glProgramUniform,GLuint,GLint,const,float,        4,4fv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_VEC(glProgramUniform,GLuint,GLint,const,int,          4,4iv_ei)

EIGEN_GL_FUNC2_SPECIALIZATION_MAT(glProgramUniform,GLuint,GLint,const,float,        2,2,Matrix2fv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_MAT(glProgramUniform,GLuint,GLint,const,float,        3,3,Matrix3fv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_MAT(glProgramUniform,GLuint,GLint,const,float,        4,4,Matrix4fv_ei)


inline void glProgramUniformMatrix2x3fv_ei(GLuint prog, GLint loc, const float* v)         { glProgramUniformMatrix2x3fv(prog,loc,1,false,v); }
inline void glProgramUniformMatrix3x2fv_ei(GLuint prog, GLint loc, const float* v)         { glProgramUniformMatrix3x2fv(prog,loc,1,false,v); }
inline void glProgramUniformMatrix2x4fv_ei(GLuint prog, GLint loc, const float* v)         { glProgramUniformMatrix2x4fv(prog,loc,1,false,v); }
inline void glProgramUniformMatrix4x2fv_ei(GLuint prog, GLint loc, const float* v)         { glProgramUniformMatrix4x2fv(prog,loc,1,false,v); }
inline void glProgramUniformMatrix3x4fv_ei(GLuint prog, GLint loc, const float* v)         { glProgramUniformMatrix3x4fv(prog,loc,1,false,v); }
inline void glProgramUniformMatrix4x3fv_ei(GLuint prog, GLint loc, const float* v)         { glProgramUniformMatrix4x3fv(prog,loc,1,false,v); }

EIGEN_GL_FUNC2_SPECIALIZATION_MAT(glProgramUniform,GLuint,GLint,const,float,        2,3,Matrix2x3fv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_MAT(glProgramUniform,GLuint,GLint,const,float,        3,2,Matrix3x2fv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_MAT(glProgramUniform,GLuint,GLint,const,float,        2,4,Matrix2x4fv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_MAT(glProgramUniform,GLuint,GLint,const,float,        4,2,Matrix4x2fv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_MAT(glProgramUniform,GLuint,GLint,const,float,        3,4,Matrix3x4fv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_MAT(glProgramUniform,GLuint,GLint,const,float,        4,3,Matrix4x3fv_ei)

inline void glProgramUniform2uiv_ei (GLuint prog, GLint loc, const unsigned int* v)  { glProgramUniform2uiv(prog,loc,1,v); }
inline void glProgramUniform3uiv_ei (GLuint prog, GLint loc, const unsigned int* v)  { glProgramUniform3uiv(prog,loc,1,v); }
inline void glProgramUniform4uiv_ei (GLuint prog, GLint loc, const unsigned int* v)  { glProgramUniform4uiv(prog,loc,1,v); }

EIGEN_GL_FUNC2_SPECIALIZATION_VEC(glProgramUniform,GLuint,GLint,const,unsigned int, 2,2uiv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_VEC(glProgramUniform,GLuint,GLint,const,unsigned int, 3,3uiv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_VEC(glProgramUniform,GLuint,GLint,const,unsigned int, 4,4uiv_ei)

inline void glProgramUniform2dv_ei  (GLuint prog, GLint loc, const double* v)        { glProgramUniform2dv(prog,loc,1,v); }
inline void glProgramUniform3dv_ei  (GLuint prog, GLint loc, const double* v)        { glProgramUniform3dv(prog,loc,1,v); }
inline void glProgramUniform4dv_ei  (GLuint prog, GLint loc, const double* v)        { glProgramUniform4dv(prog,loc,1,v); }

EIGEN_GL_FUNC2_SPECIALIZATION_VEC(glProgramUniform,GLuint,GLint,const,double,       2,2dv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_VEC(glProgramUniform,GLuint,GLint,const,double,       3,3dv_ei)
EIGEN_GL_FUNC2_SPECIALIZATION_VEC(glProgramUniform,GLuint,GLint,const,double,       4,4dv_ei)
