...
public:
    ...
    virtual void set(const Program * program, gl::GLint location, const TextureHandle & value) const;
    ...
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Vector2f> & value) const = 0;
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Vector3f> & value) const = 0;
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Vector4f> & value) const = 0;

    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Vector2i> & value) const = 0;
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Vector3i> & value) const = 0;
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Vector4i> & value) const = 0;

    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Matrix<unsigned int, 2, 1>> &value) const = 0;
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Matrix<unsigned int, 3, 1>> &value) const = 0;
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Matrix<unsigned int, 4, 1>> &value) const = 0;

    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Matrix2f> & value) const = 0;
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Matrix3f >& value) const = 0;
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Matrix4f> & value) const = 0;

    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Matrix<float, 2, 3>> & value) const = 0;
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Matrix<float, 3, 2>> & value) const = 0;
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Matrix<float, 2, 4>> & value) const = 0;
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Matrix<float, 4, 2>> & value) const = 0;
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Matrix<float, 3, 4>> & value) const = 0;
    virtual void set(const Program *program, gl::GLint location, const AbstractUniform::EigenStdVector<Eigen::Matrix<float, 4, 3>> & value) const = 0;
    */
