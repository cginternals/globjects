...
int main(int /*argc*/, char * /*argv*/[])
{
    ...
    std::cout << "  Query                 : "; info() << query;
    auto rbo = new Renderbuffer();
    std::cout << "  Renderbuffer          : "; info() << rbo;
    auto sampler =new Sampler();
    std::cout << "  Sampler               : "; info() << sampler;
    auto shader = new Shader(GL_VERTEX_SHADER);
    std::cout << "  Shader                : "; info() << shader;
    auto texture = new Texture();
    std::cout << "  Texture               : "; info() << texture;
    auto tf = new TransformFeedback();
    std::cout << "  TransformFeedback     : "; info() << tf;
    auto vao = new VertexArray();
    std::cout << "  VertexArray           : "; info() << vao;
    auto uniform = new Uniform<float>("Pi", 3.14f);
    std::cout << "  Uniform               : "; info() << uniform;
    std::cout << "  AbstractUniform       : "; info() << static_cast<AbstractUniform*>(uniform);
