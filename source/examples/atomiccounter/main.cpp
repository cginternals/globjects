...
public:
    ...
    virtual void initialize(Window & window) override
    {
        ...
        m_gBufferChoice = new ScreenAlignedQuad(
            Shader::fromFile(GL_FRAGMENT_SHADER, "data/gbuffers/gbufferchoice-atomic.frag"));
    ...
    virtual void paintEvent(PaintEvent & event) override
    {
        ...
        m_frameCount = (m_frameCount + 100) % (m_camera.viewport().x * m_camera.viewport().y);
...
protected:
    ...
    ref_ptr<Buffer> m_atomicCounterBuffer;
