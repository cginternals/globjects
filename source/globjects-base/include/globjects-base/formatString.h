...
GLOBJECTS_BASE_API int readInt(const char* str, int& number);
GLOBJECTS_BASE_API void parseFormat(std::ostream& stream, const char*& format);

GLOBJECTS_BASE_API void streamprintf(std::ostream& stream, const char* format);
